                    ...
                    <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                        <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
                            ...
                            <div className='flex justify-center items-center gap-2 text-2xl w-full'>
                                <Link to='/'>Home</Link>
                                <span className='pt-2'><MdOutlineKeyboardDoubleArrowRight /></span>
                                <span>Card</span>
                            </div>
                        </div>
                    </div>
                                        ...
                                        </div>
                                        {
                                            card_products.map((p, i) => <div className='flex bg-white p-4 flex-col gap-2'>
                                                <div className='flex justify-start items-center'>
                                                    <h2 className='text-md text-slate-600'>Jakir Fashion</h2>
                                                </div>
                                                {
                                                    [1, 2].map((p, i) => <div className='w-full flex flex-wrap'>
                                                        <div className='flex sm:w-full gap-2 w-7/12'>
                                                            <div className='flex gap-2 justify-start items-center'>
                                                                <img className='w-[80px] h-[80px]' src={`http://localhost:3000/images/products/${i + 2}.webp`} alt="product img" />
                                                        ...
                                                        <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                            ...
                                                            <div className='flex gap-2 flex-col'>
                                                                <div className='flex bg-slate-200 h-[30px] justify-center items-center'>
                                                                    <div className='px-3 cursor-pointer'><AiOutlineMinus /></div>
                                                                    <div className='px-3 text-xl'>5</div>
                                                                    <div className='px-3 cursor-pointer'><AiOutlinePlus /></div>
                                                                </div>
                                                                <button className='px-5 py-[3px] bg-red-500 text-white hover:bg-red-600'>Delete</button>
                                                            </div>
                                                        </div>
                                                    </div>)
                                                }
                                                ...
                                                <div className='bg-white p-4'>
                                                    {
                                                        [1, 2].map((p, i) => <div className='w-full flex flex-wrap'>
                                                            <div className='flex sm:w-full gap-2 w-7/12'>
                                                                <div className='flex gap-2 justify-start items-center'>
                                                                    <img className='w-[80px] h-[80px]' src={`http://localhost:3000/images/products/${i+ 2}.webp`} alt="product image" />
                                                                    <div className='pr-4 text-slate-600'>
                                                                        <h2 className='text-md'>Long Sleeve casua Shirt for Man</h2>
                                                                        <span className='text-sm'>Brand : Easy</span>
                                                                    </div>
