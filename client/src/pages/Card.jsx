                                                    ...
                                                    <div className="w-full flex flex-wrap" key={i}>
                                                        <div className="flex sm:w-full gap-2 w-7/12">
                                                            <div className="flex gap-2 justify-start items-center">
                                                                <img
                                                                    ...
                                                                    src={`http://localhost:3000/images/products/${i + 2
                                                                        }.webp`}
                                                                    alt="product img"
                                                                />
                                                        ...
                                                        <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                                            ...
                                                            <div className="flex gap-2 flex-col">
                                                                ...
                                                                <button className="px-5 py-[3px] bg-red-500 text-white hover:bg-red-600">
                                                                    Delete
                                                                </button>
                                                            </div>
                                                        </div>
                                ...
                                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                                    {card_products.length > 0 && (
                                        <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                                            ...
                                            <button onClick={onRedirect} className="px-5 py-[6px] rounded-sm hover:shadow-orange-500/20 hover:shadow-lg bg-orange-500 text-sm text-white uppercase">
