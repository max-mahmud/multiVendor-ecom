        ...
        <div>
            <div className='mt-8'>
                ...
                <div className='flex flex-col gap-8 pb-10 pt-4'>
                    {
                        [1, 2, 3, 4, 5, 6].map((r, i) => <div key={i} className='flex shadow p-3 flex-col gap-1'>
                            ...
                            <span className='text-slate-600 text-md'>Jakir</span>
                ...
                <div>
                    {
                        userInfo ? <div className='flex flex-col gap-3'>
                            ...
                            <Link className='py-2 px-7 bg-indigo-500 text-white rounded-sm' to='/login'>Login</Link>
                        </div>
                    }
                </div>
            </div>
