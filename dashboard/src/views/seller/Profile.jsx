                ...
                <div className="w-full md:w-6/12">
                    <div className="w-full bg-[#283046] p-4 rounded-md text-[#d0d2d6] ">
                        <div className="flex justify-center items-center py-3">
                            {
                                userInfo?.image ? <label htmlFor="img" className='h-[240px] w-[300px] o relative p-3 cursor-pointer overflow-hidden'>
                                    <img className='w-full h-full ' src={userInfo.image} alt="img" />
                                    {
                                        loader && <div className='bg-slate-800 absolute left-0 top-0 w-full h-full opacity-70 flex justify-center items-center z-[999]'>
