        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className="w-full bg-[#283046] p-4 rounded-md">
                <div className="flex justify-between items-center">
                    <h2 className="text-xl text-[#d0d2d6] font-medium">Order Details</h2>
                    <select className='bg-[#283046] border border-slate-700 px-4 py-2 rounded-md focus:outline-none focus:border-indigo-600 text-[#d0d2d6] capitalize' >
                        <option value="">pending</option>
                        <option value="">Procceesing</option>
                        ...
                        <div className='w-[32%]'>
                            <div className='pr-3 text-[#d0d2d6] text-lg'>
                                <div className='flex flex-col gap-1'>
                                    <h2 className='pb-2 font-semibold'>Deliver to : Ishak Mia</h2>
